...
class DashboardController extends Controller
{
    public function index()
    {
        $stats = [
            ...
            'warga_gte17' => Warga::whereNotNull('tanggal_lahir')->whereRaw("TIMESTAMPDIFF(YEAR, tanggal_lahir, CURDATE()) >= 17")->count(),
            'warga_lt17' => Warga::whereNotNull('tanggal_lahir')->whereRaw("TIMESTAMPDIFF(YEAR, tanggal_lahir, CURDATE()) < 17")->count(),
